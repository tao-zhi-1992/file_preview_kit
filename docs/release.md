...
1. Move any draft notes into a version section in [CHANGELOG.md](../CHANGELOG.md) (for example `## 0.0.3`). Do not leave an empty `## Unreleased` heading — pub.dev surfaces it.
